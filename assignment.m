...
plotting(healthy,chest_pain_type_h,fbs_h,ecg_h,exang_h,slope_h,ca_h,thal_h,gender_h,4);

prob_female = gender(2)/88 *100;
prob_male = gender(1) /88 *100;
